...
user1, created = User.objects.get_or_create(username='user_manager1', password='456')
Admin_user_grp.user_set.add(user1)
...
item1, created = User.objects.get_or_create(username='item_manager1', password='789')
Admin_item_grp.user_set.add(item1)
